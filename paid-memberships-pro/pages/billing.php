	...
	<?php } else { ?>
		...
		<form id="pmpro_form" class="pmpro_form" action="<?php echo pmpro_url("billing", "", "https")?>" method="post">
			...
			<div id="pmpro_billing_address_fields" class="pmpro_checkout">
				...
				<div class="pmpro_checkout-fields">
					...
					<div class="pmpro_checkout-field pmpro_checkout-field-baddress2">
						...
						<input id="baddress2" name="baddress2" type="text" class="input form-control <?php echo pmpro_getClassForField("baddress2");?>" size="30" value="<?php echo esc_attr($baddress2);?>" /> <small class="lite">(<?php _e('optional', 'paid-memberships-pro' );?>)</small>
					...
					<div class="pmpro_checkout-field pmpro_checkout-field-bphone">
						...
						<input id="bphone" name="bphone" type="text" class="input form-control <?php echo pmpro_getClassForField("bphone");?>" size="30" value="<?php echo esc_attr($bphone)?>" />
				...
				<div id="pmpro_payment_information_fields" class="pmpro_checkout">
					...
					<div class="pmpro_checkout-fields">
						...
						<div class="pmpro_checkout-field pmpro_payment-account-number">
							...
							<input id="AccountNumber" name="AccountNumber" class="input form-control <?php echo pmpro_getClassForField("AccountNumber");?>" type="text" size="25" value="<?php echo esc_attr($AccountNumber)?>" autocomplete="off" />
						</div>
			...
			<div class="pmpro_submit">
				...
				<input type="submit" class="btn btn-primary btn-large pmpro_btn pmpro_btn-submit" value="<?php _e('Update', 'paid-memberships-pro' );?>" />
