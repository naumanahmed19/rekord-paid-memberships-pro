...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<?php if ($discount_code && $pmpro_review) { ?>
		<input class="input form-control <?php echo pmpro_getClassForField("discount_code");?>" id="discount_code" name="discount_code" type="hidden" size="20" value="<?php echo esc_attr($discount_code) ?>" />
	<?php } ?>
		...
		<div id="pmpro_pricing_fields" class="pmpro_checkout">
			...
			<div class="pmpro_checkout-fields">
				...
				<div id="other_discount_code_tr" style="display: none;">
					...
					<input id="other_discount_code" name="other_discount_code" type="text" class="input form-control <?php echo pmpro_getClassForField("other_discount_code");?>" size="20" value="<?php echo esc_attr($discount_code); ?>" />
	...
	<div id="pmpro_user_fields" class="pmpro_checkout">
		...
		<div class="pmpro_checkout-fields">
			...
			<div class="pmpro_hidden">
				...
				<input id="fullname" name="fullname" type="text" class="input form-control <?php echo pmpro_getClassForField("fullname");?>" size="30" value="" autocomplete="off"/> <strong><?php _e('LEAVE THIS BLANK', 'paid-memberships-pro' );?></strong>
		...
		<div id="pmpro_payment_information_fields" class="pmpro_checkout" <?php if(!$pmpro_requirebilling || apply_filters("pmpro_hide_payment_information_fields", false) ) { ?>style="display: none;"<?php } ?>>
			...
			<div class="pmpro_checkout-fields">
				...
				<div class="pmpro_checkout-field pmpro_payment-expiration">
					...
					<div class="d-flex align-items-cetner w-50">
				...
				<?php if($pmpro_show_discount_code) { ?>
					<div class="pmpro_checkout-field pmpro_payment-discount-code">
						...
						<input class="input form-control <?php echo pmpro_getClassForField("discount_code");?>" id="discount_code" name="discount_code" type="text" size="10" value="<?php echo esc_attr($discount_code); ?>" />
		...
		<?php } else { ?>
			...
			<?php
				...
				<span id="pmpro_submit_span">
					...
					<input type="submit"  id="pmpro_btn-submit" class="btn btn-primary btn-large pmpro_btn pmpro_btn-submit-checkout" value="<?php if($pmpro_requirebilling) { _e('Submit and Check Out', 'paid-memberships-pro' ); } else { _e('Submit and Confirm', 'paid-memberships-pro' );}?> &raquo;" />
				</span>
				<?php
				}
			?>
